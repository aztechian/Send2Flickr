...
public class FlickrAuthorize extends Observable
{
	...
	public String getLoginLink()
	{
		...
		return String.format("http://flickr.com/services/auth/?api_key=%s&perms=%s&frob=%s&api_sig=%s", api_key, perms, frob, api_sig);
	}
	...
	public boolean getToken()
	{
		...
		String location = String.format( "http://api.flickr.com/services/rest/?method=%s&api_key=%s&frob=%s&api_sig=%s",
				"flickr.auth.getToken", api_key, frob, api_sig );
		URL url;
